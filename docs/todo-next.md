...
- [ ] **T3.2** 🔴 高 | 注册页重构 `views/Register.vue`
  - 与登录页风格统一
  - 同样使用 `GradientBg` + `GlassCard`
  - 表单字段与登录页一致的输入框样式
  - 添加注册成功动画反馈

- [ ] **T3.3** 🔴 高 | 主页重构 `views/Home.vue`
  - 导航栏毛玻璃化（T2.1 成果）
...
- [ ] **T3.4** 🟡 中 | 任务详情页重构 `views/TaskDetail.vue`
...
- [ ] **T3.6** 🟡 中 | 管理员面板重构 `views/Admin.vue`
...
| Phase 2 - 公共组件 | 4 | 3 | 1 | 0 | 0/4 |
| Phase 3 - 页面重构 | 6 | 3 | 3 | 0 | 0/6 |
| Phase 4 - 交互动画 | 4 | 0 | 3 | 1 | 0/4 |
| Phase 5 - 性能优化 | 4 | 2 | 2 | 0 | 0/4 |
| **合计** | **22** | **11** | **10** | **1** | **4/22** |
