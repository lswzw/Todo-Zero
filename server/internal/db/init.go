...
var indexStatements = []string{
	...
	`CREATE INDEX IF NOT EXISTS idx_tasks_priority ON tasks (user_id, priority, is_deleted)`,
	`CREATE INDEX IF NOT EXISTS idx_tasks_user_category ON tasks (user_id, category_id, is_deleted)`,
	`CREATE INDEX IF NOT EXISTS idx_tasks_end_time ON tasks (user_id, end_time, is_deleted)`,
	`CREATE INDEX IF NOT EXISTS idx_users_username ON users (username, is_deleted)`,
	`CREATE INDEX IF NOT EXISTS idx_users_status ON users (status, is_deleted)`,
	...
	`CREATE INDEX IF NOT EXISTS idx_login_log_user_time ON login_log (username, create_time)`,
